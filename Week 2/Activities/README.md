...
In this folder, the student will find the files containing the solution for Activity 1 - 7.
...
## Activities
The instructions for each activity are located in the presentations.
