...
The first part of this course introduces the basic concepts and general knowledge of the ROS environment to the user. The second part of the course is dedicated to the analysis, control, and simulation of mobile robots in different environments.
...
Please be aware that a set of requirements specific to each session will be shown in each session subsection (Some items may be repeated).
•	Computer with access to Teams (online classes if applicable).
•	Computer with Ubuntu 20.04 and ROS Noetic or the Virtual Machine provided by the professor.
...
## Disciplinary Policy
The following will be considered disciplinary infractions during this course:
•	Chatting during class.
•	Disrespecting fellow students
•	Using the internet browser or mobile phone for social networking.
•	Working on assignments for other courses.
Students will receive a warning for the first incident. For a second incident, the student will be penalised in the integrity competency.

## Evaluation Policy
Each student will receive fair and equitable evaluations through exams and the presentation of project progress, culminating in a final project.
•	Exams: Each exam will cover all topics outlined in the syllabus, and self-study assignments will also be evaluated.
•	Activities: Each activity and Coursework will cover the the topics of the week and will be considered for the final grade of this course.
•	Final Project: Final Project covers all the topics viewed during the sessions
...
This session will introduce the teaching team and the basics of ROS.
  ...
  •	Activity 1: Talker and Listener
    o	Generate a node that sends a message to another node to listen to it.
  •	Activity 2: Launch Files
    o	Create a Launch file for the nodes created.


  #### Coursework
  •	CW1: ROS Nodes
    o	Generate a node that sends a signal to another node to process it.
...
This week, we will deliver a comprehensive introduction to some of the most practical and relevant features of the Robot Operating System (ROS).
  ...
  •	CW2: Mobile robot
    o	Show a simple mobile robot in RVIZ using markers and TF.
...
#### Activities
  •	Activity 1: DC Motor Simulation.
    o	Simulate the dynamics of a Motor.

#### Coursework
  •	CW 3: DDR Kinematic Simulator
    o	Develop a node to perform a kinematic simulation of a DDR.
...
### Week 4: Open Loop/Closed Loop Control.
This week an exam on State of the Art will be presented to grade the competency SMR0401
This week will introduce some basics of open-loop and closed-loop control for mobile robotics.
  ...
  •	Activity 1: Teleoperation of a mobile robot.
    o	Simple DDR control.
  •	Activity 2: Open Loop control for a DDR.
    o	Open Loop Path following of a real Mobile Robot
  •	Activity 3: Teleoperation of a mobile robot.
    o	Simple closed-loop control



  #### Final Project: 
  •	Final Project 5: Closed loop control of a mobile robot
...
### Week 5: Exam Week.
•	Final Exam
•	Mid term presentation with the industry partner
